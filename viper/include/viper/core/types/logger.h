#ifndef __header_viper_core_types_logger__
#define __header_viper_core_types_logger__

#define VIPER_LOG_LEVEL_DEBUG       0x0001
#define VIPER_LOG_LEVEL_INFO        0x0002
#define VIPER_LOG_LEVEL_NOTICE      0x0004
